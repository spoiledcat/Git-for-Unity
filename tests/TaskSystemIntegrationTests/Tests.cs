...
namespace IntegrationTests
{
    class BaseTest
    {
        ...
        public void OneTimeSetup()
        {
            ...
            ProcessManager = new ProcessManager(env, platform.GitProcessEnvironment, Token);
            var processEnv = platform.GitProcessEnvironment;
    ...
    class TaskToActionTask : BaseTest
    {
        ...
        public async Task Inlining()
        {
            ...
            var act = new ActionTask(Token, _ => runOrder.Add($"started"))
                .Then(Task.FromResult(1), TaskAffinity.Exclusive)
                .Then((_, n) => n + 1)
                .Then((_, n) => runOrder.Add(n.ToString()))
                .Then(Task.FromResult(20f), TaskAffinity.Exclusive)
                .Then((_, n) => n + 1)
                .Then((_, n) => runOrder.Add(n.ToString()))
    ...
    class Dependencies : BaseTest
    {
        ...
        {
            var task1 = new TPLTask(Task.FromResult(true));
            var task2 = new TestActionTask(Token, _ => { });
            var task3 = new TestActionTask(Token, _ => { });
        ...
        public async Task MergingTwoChainsWorks()
        {
            ...
            var innerChainTask1 = new TPLTask(Task.FromResult(LogAndReturnResult(callOrder, "chain2 completed1", true)));
    ...
    class TaskQueueTests : BaseTest
    {
        ...
        public void ConvertsTaskResultsCorrectly()
        {
            ...
            vals.All(s => { queue.Queue(new TPLTask<string>(Task.FromResult(s))); return true; });
