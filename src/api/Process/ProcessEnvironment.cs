...
namespace Unity.VersionControl.Git
{
	...
	{
		IBaseEnvironment Environment { get; }
	...
	{
		public IBaseEnvironment Environment { get; private set; }
		protected ILogging Logger { get; private set; }
		public NPath DefaultWorkingDirectory { get; private set; }

		public ProcessEnvironment(IBaseEnvironment environment, NPath defaultWorkingDirectory)
		{
