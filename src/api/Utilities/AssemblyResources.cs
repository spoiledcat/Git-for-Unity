...
namespace Unity.VersionControl.Git
{
    ...
    {
        private static (string type, string os) ParseResourceType(ResourceType resourceType, IBaseEnvironment environment)
        {
            var os = "";
        ...
        private static NPath TryGetFile(ResourceType resourceType, string resource, IBaseEnvironment environment)
        {
            /*
                This function attempts to get files embedded in the callers assembly.
        ...
        public static NPath ToFile(ResourceType resourceType, string resource, NPath destinationPath, IBaseEnvironment environment)
        {
